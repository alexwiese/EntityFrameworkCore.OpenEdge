...
//             _output.WriteLine($"Found {customersWithOrders.Count} customers");
...
//         [Fact]
//         public void CanExecute_ProductCategoryJoin()
//         {
//             using var context = CreateContext();
...
//             _output.WriteLine($"Found {productsWithCategories.Count} products with categories");

//             productsWithCategories.Should().NotBeNull();
//         }
