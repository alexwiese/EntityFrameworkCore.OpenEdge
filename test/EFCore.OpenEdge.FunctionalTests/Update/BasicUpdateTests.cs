...
namespace EFCore.OpenEdge.FunctionalTests.Update
{
    public class BasicUpdateTests : ECommerceTestBase
    {
        ...
        public void CanInsert_Customer()
        {
            ...
            result.Should().Be(1);
            _output.WriteLine($"Inserted customer with Id: {customer.Id}");
        ...
        public void CanInsert_Product()
        {
            ...
            result.Should().Be(1);
            _output.WriteLine($"Inserted product with Id: {product.Id}");
        ...
        public void CanInsert_Order_WithOrderItems()
        {
            ...
            _output.WriteLine($"Inserted order with {result} total changes");
        ...
        public void CanUpdate_Customer()
        {
            ...
            result.Should().Be(1);
            _output.WriteLine($"Updated customer: {originalName} -> {customer.Name}");
        ...
        public void CanUpdate_Product_Price()
        {
            ...
            result.Should().Be(1);
            _output.WriteLine($"Updated product price: {originalPrice} -> {product.Price}");
        ...
        public void CanUpdate_Order_Status()
        {
            ...
            result.Should().Be(1);
            _output.WriteLine($"Updated order status: {originalStatus} -> {order.Status}");
        ...
        public void CanDelete_Customer()
        {
            ...
            result.Should().Be(1);
            _output.WriteLine($"Deleted customer: {customer.Name}");
        ...
        public void CanDelete_Product()
        {
            ...
            result.Should().Be(1);
            _output.WriteLine($"Deleted product: {product.Name}");
        ...
        public void CanDelete_OrderItem()
        {
            ...
            result.Should().Be(1);
            _output.WriteLine($"Deleted order item from order {orderId}");
        ...
        public void CanUpdate_Multiple_Entities()
        {
            ...
            _output.WriteLine($"Updated {result} customers in New York");
        ...
        public void CanUpdate_With_Navigation_Properties()
        {
            ...
            _output.WriteLine($"Updated order and order item, total changes: {result}");
        ...
        public void Should_Fail_Update_NonExistent_Entity()
        {
            ...
            _output.WriteLine($"Update resulted in {result} changes");
        }
